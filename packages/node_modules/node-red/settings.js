 ...
 ******************************************************************************/
     ...
     * 
     * 在本项目中，我们将其指向仓库内的 `custom-nodes` 目录，
     * 这样 `math-calculator` 和 `blank-rect` 等自定义节点就会自动加载。
     */
    nodesDir: '/Users/limu/Desktop/githubs/2_gridstack/gridstack/react-ai_studio/react-low-code-engine/Orchestrator/custom-nodes',
